  ...
  return (
    <div className="p-6">
      ...
      <p className="text-text-secondary text-sm mb-6">
        Manage client onboarding, seat allocations, status, and contact info.
      </p>

      {/* Existing Clients */}
      <div className="card overflow-x-auto mb-6">
        <div className="grid grid-cols-8 gap-2 px-4 py-3 text-xs font-semibold text-text-secondary uppercase tracking-wider border-b border-border-subtle bg-bg-elevated/50 min-w-[900px]">
          <div>Company ID</div>
        ...
        {clients.map((client) => (
          <div key={client.id} className="grid grid-cols-8 gap-2 px-4 py-3 items-center border-b border-border-subtle min-w-[900px]">
            <div className="text-sm text-text-secondary tabular-nums truncate" title={client.company_id}>
              {client.company_id}
            </div>
            ...
            <div>
              <input
                ...
                className="w-16 px-2 py-1 text-sm rounded border border-border-subtle bg-bg-base text-text-primary focus:outline-none focus:border-accent-cyan/40"
              />
            </div>
            <div>
              <select
                ...
                className="px-2 py-1 text-sm rounded border border-border-subtle bg-bg-base text-text-primary focus:outline-none focus:border-accent-cyan/40"
              >
                {statusOptions.map((s) => (
            ...
            <div>
              <input
                ...
                placeholder="email"
                className="w-full px-2 py-1 text-sm rounded border border-border-subtle bg-bg-base text-text-primary focus:outline-none focus:border-accent-cyan/40"
              />
            </div>
            <div>
              <input
            ...
            <div className="text-right">
              <button
                ...
                className="p-1.5 rounded hover:bg-tier-red/20 text-text-secondary hover:text-tier-red transition-colors"
                title="Delete client"
              >
                <Trash2 size={14} />
              </button>
      ...
      <div className="card p-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
          <div>
            <label className="block text-xs text-text-secondary mb-1">Company ID (GHL Location)</label>
            <input
              type="text"
              value={newRow.company_id}
              onChange={(e) => setNewRow({ ...newRow, company_id: e.target.value })}
              className="w-full px-3 py-2 text-sm rounded-lg border border-border-subtle bg-bg-base text-text-primary focus:outline-none focus:border-accent-cyan/40"
          ...
          <div>
            <label className="block text-xs text-text-secondary mb-1">Seats Purchased</label>
            <input
              type="number"
              min={1}
          ...
          <div>
            <label className="block text-xs text-text-secondary mb-1">Onboarding Date</label>
            <input
              type="date"
          ...
          <div>
            <label className="block text-xs text-text-secondary mb-1">Launch Date</label>
            <input
              type="date"
